...
ax.set_title('#1: Unique Users on Jan 1')
ax.set_ylabel('Users')
...
plt.title('#2: Unique Users on Dec 31')
plt.ylabel('Users')
...
plt.title('#4: New/First-Time Users')
plt.ylabel('Users')
plt.subplots_adjust(bottom=0.3)
...
plt.title('Branch-wise Print Jobs: 2023 vs 2024')
plt.ylabel('Jobs')
...
plt.title('Monthly Print Jobs Breakdown: 2023 vs 2024')
plt.legend()
plt.tight_layout()
...
plt.title('#8: $ Value of Print Jobs Actually Paid For')
plt.ylabel('Dollars ($)')
table = plt.table(cellText=[
...
plt.title('#9: Total Printer Usage Time (Hours)')
plt.ylabel('Hours')
...
plt.title('#10: Cost vs Revenue (with Breakdown)')
plt.ylabel('Dollars ($)')
plt.legend()
plt.tight_layout()
